...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 977052611;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
    stem: 'rust_lib_testflutterbridge',
...
abstract class RustLibApi extends BaseApi {
  ...
  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_Nlu;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Nlu> crateApiSimpleNluNew({required String engineDir, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_String(engineDir, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 3, port: port_);
      },
      codec: SseCodec(
        decodeSuccessData:
            sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerNLU,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiSimpleNluNewConstMeta,
      argValues: [engineDir],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiSimpleNluNewConstMeta => const TaskConstMeta(
        debugName: "Nlu_new",
        argNames: ["engineDir"],
      );
  ...
  TaskConstMeta get kCrateApiSimpleNluParseIntentConstMeta =>
      const TaskConstMeta(
        debugName: "Nlu_parse_intent",
        argNames: ["that", "input"],
      );
  ...
  RustArcIncrementStrongCountFnType get rust_arc_increment_strong_count_Nlu => wire
